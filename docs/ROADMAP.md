...
- [ ] **Salto da Jubarte:** (Ao final do caminho) O jogador recebe um convite para realizar um salto majestoso. Ao pressionar a tecla "Espaço" no momento certo, a baleia salta para fora d'água, gerando um bônus de "prestígio ecológico" dos turistas que observam da encosta.
...
- [x] **Ecolocalização / Canto da Baleia (Tecla Shift ou E):** Ao pressionar a tecla, a baleia emite uma onda de sonar visível. Essa onda revela a silhueta de obstáculos à frente na água turva.
